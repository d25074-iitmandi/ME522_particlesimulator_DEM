...
set grid #xtics ytics lc rgb 'gray' lw 1
set logscale y
set format y "10^{%L}"
...
plot 'results_final/system_data_200_parallel.txt' using 1:2 with lines ls 1 title 'N=200', 'results_final/system_data_1000_parallel.txt' using 1:2 with lines ls 2 title 'N=1000', 'results_final/system_data_5000_parallel.txt' using 1:2 with lines ls 3 title 'N=5000'
